...
##  Generate a Word Cloud - Example
![natural_language_Processing](./NLP1.png) 

## Using ggplot Generate a visualization of the mean sentiment score over weeks, remove rows that have readings from other classes (NA for weeks)
![natural_language_Processing](./NLP2.png) 

## LDA Topic Modelling
![natural_language_Processing](./NLP3.png) 
